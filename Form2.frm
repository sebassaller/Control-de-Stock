...
Begin VB.Form Form2 
   ...
   Begin ChamaleonButton.ChameleonBtn anterior 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "Form2.frx":14C61
      PICN            =   "Form2.frx":14C7D
      PICH            =   "Form2.frx":15557
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin ChamaleonButton.ChameleonBtn siguente 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "Form2.frx":15E31
      PICN            =   "Form2.frx":15E4D
      PICH            =   "Form2.frx":16727
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ChamaleonButton.ChameleonBtn nuevo 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "Form2.frx":17001
         PICN            =   "Form2.frx":1701D
         PICH            =   "Form2.frx":178F7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn editar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "Form2.frx":181D1
         PICN            =   "Form2.frx":181ED
         PICH            =   "Form2.frx":18AC7
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn eliminar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "Form2.frx":193A1
         PICN            =   "Form2.frx":193BD
         PICH            =   "Form2.frx":19C97
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn guardar 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "Form2.frx":1A571
         PICN            =   "Form2.frx":1A58D
         PICH            =   "Form2.frx":1AE67
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin ChamaleonButton.ChameleonBtn cancelar 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "Form2.frx":1B741
         PICN            =   "Form2.frx":1B75D
         PICH            =   "Form2.frx":1C037
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ChamaleonButton.ChameleonBtn calendario 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "Form2.frx":1C911
         PICN            =   "Form2.frx":1C92D
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   600
         ItemData        =   "Form2.frx":1D207
         Left            =   1680
         List            =   "Form2.frx":1D223
         TabIndex        =   4
         Top             =   1200
         Width           =   3495
      End
...
Dim por, a, e As Double
Dim i As Integer
i = Val(InputBox("ingrese el porsentaje a sumar", "SACAR PRECIO SUGERIDO"))
...
If (Adodc1.Recordset.EOF = False) Then
If Adodc1.Recordset(4).Value = Text6.Text Then
   Dim color, cod As String
    MsgBox ("mercaderia en vencimiento")
    color = Me.DataGrid1.Row
    cod = DataGrid1.Columns(4).Value
...
Public Sub sacar_id()
Dim id_inicial As Integer
id_inicial = Adodc1.Recordset.RecordCount
Text5.Text = id_inicial
End Sub
